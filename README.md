...
TabbyNotes asks for no permissions in Firefox. In Chrome it requests only `sidePanel`, which shows no install warning. Images in notes load from wherever their URL points, without sending a referrer.
